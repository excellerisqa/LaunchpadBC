...
public class VSTS_11421 extends BaseClass {
	...
	public void verifyTestCatalougeSuccessMsg(boolean bugflag, boolean exceptionflag) throws Exception {
		try {
			...
			BaseClass.bh.getAllSteps(11421);
			...
			if (!(loincID.replaceAll(" ", "")
					.equalsIgnoreCase(BaseClass.xlhandler.getDatabyCell(1, 5, 1).replaceAll(" ", "")))) {
		...
		BaseClass.bh.createbug(exceptionError, bugflag, exceptionflag, "VSTS_ID_11421", BaseClass.AssignedTo,
