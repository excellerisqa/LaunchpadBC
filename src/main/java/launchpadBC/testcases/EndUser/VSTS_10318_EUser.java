...
public class VSTS_10318_EUser extends BaseClass_EUser {
	...
	public void testmodals(boolean bugflag, boolean exceptionflag) throws Exception {
		...
		BaseClass_EUser.bh.createbug(exceptionError, bugflag, exceptionflag, "VSTS_ID_10318", BaseClass_EUser.AssignedTo,
