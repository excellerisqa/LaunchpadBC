...
public class VSTS_11434_EUser extends BaseClass_EUser {
	...
	public void testmodals(boolean bugflag, boolean exceptionflag) throws Exception {
		...
		BaseClass_EUser.bh.createbug(exceptionError, bugflag, exceptionflag, "VSTS_ID_11434", BaseClass_EUser.AssignedTo,
