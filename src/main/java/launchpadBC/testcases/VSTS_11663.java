...
public class VSTS_11663 extends BaseClass {
	...
	public void statusUpdateAccession(boolean bugflag, boolean exceptionflag) throws Exception {
		try {
			...
			BaseClass.bh.getAllSteps(11663);
		...
		BaseClass.bh.createbug(exceptionError, bugflag, exceptionflag, "VSTS_ID_11663", BaseClass.AssignedTo,
