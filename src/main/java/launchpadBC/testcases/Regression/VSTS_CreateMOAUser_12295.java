...
public class VSTS_CreateMOAUser_12295 extends BaseClass_Regression {
	...
	public void CreateMOAUser(boolean bugflag, boolean exceptionflag) throws Exception {
		...
		try {
			ObjectHelper.test = ObjectHelper.reports.createTest("VSTS_12295");
			BaseClass_Regression.bh.getAllSteps(12295);
			System.out.println("VSTS_CreateMOAUser_12295 started");
			...
			String[] rowUserData = XLHandler.readexcel(2, 1, testDataFileName); // get testdata from sheet
			...
			String[] rowProviderData = XLHandler.readexcel(2, 2, testDataFileName); // get testdata from sheet
