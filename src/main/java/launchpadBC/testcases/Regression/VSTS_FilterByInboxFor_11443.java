...
public class VSTS_FilterByInboxFor_11443 extends BaseClass_Regression {
	...
	public void filterByTest(boolean bugflag, boolean exceptionflag) throws Exception {
		try {
			ObjectHelper.test = ObjectHelper.reports.createTest("VSTS_11443");
			// BaseClass.bh.getAllSteps(11255);
			System.out.println("VSTS_FilterByInboxFor_11443 started");
			Thread.sleep(3000);
			...
			js.executeScript("arguments[0].click();", ObjectHelper.driver.findElement(BC_Inbox.inboxForcheckBox));
			js.executeScript("arguments[0].click();", ObjectHelper.driver
					.findElement(By.xpath("//input[@id='chkPhysician']//parent::td//img[@id='selPhysician_drop']")));
			Thread.sleep(3000);
			System.out.println("div text:"
					+ ObjectHelper.driver.findElement(By.xpath("//div[@id='selPhysician_item_1']")).getText());
			ObjectHelper.driver.findElement(By.xpath("//div[@id='selPhysician_item_1']")).click();
		...
		BaseClass_Regression.bh.createbug(exceptionError, bugflag, exceptionflag, "VSTS_ID_11443",
