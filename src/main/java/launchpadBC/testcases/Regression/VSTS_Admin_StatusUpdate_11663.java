...
public class VSTS_Admin_StatusUpdate_11663 extends BaseClass_Regression {
	...
	public void statusUpdateAccession(boolean bugflag, boolean exceptionflag) throws Exception {
		try {
			...
			BaseClass_Regression.bh.getAllSteps(11663);
			System.out.println("VSTS_11663_Status Update started");
			...
			ObjectHelper.driver.findElement(BC_StatusUpdate.accessionListBox)
					.sendKeys(BaseClass_Regression.xlhandler.getDatabyCell(2, 25, 1));
			Thread.sleep(2000);
			/*
			 * BC_StatusUpdate.selectupdatetype("ListedDoctors"); Thread.sleep(2000);
			 * ObjectHelper.driver.findElement(BC_StatusUpdate.updateDocListBox)
			 * .sendKeys(BaseClass_Regression.xlhandler.getDatabyCell(1, 7, 2));
			 */
		...
		BaseClass_Regression.bh.createbug(exceptionError, bugflag, exceptionflag, "VSTS_ID_11663",
