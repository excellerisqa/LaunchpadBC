...
public class VSTS_FilterByOtherReport_11441 extends BaseClass_Regression {
	...
	public void filterByTest(boolean bugflag, boolean exceptionflag) throws Exception {
		try {
			ObjectHelper.test = ObjectHelper.reports.createTest("VSTS_11441");
			// BaseClass.bh.getAllSteps(11255);
			System.out.println("VSTS_FilterByOtherReport_11441 started");
			Thread.sleep(3000);
			...
			js.executeScript("arguments[0].click();", ObjectHelper.driver.findElement(BC_Inbox.otherReportcheckBox));
			Thread.sleep(3000);
			js.executeScript("arguments[0].click();", ObjectHelper.driver.findElement(
					By.xpath("//input[@id='chkOtherReports']//parent::td//img[@id='selOtherReports_drop']")));
			Thread.sleep(3000);
			System.out.println("div text:"
					+ ObjectHelper.driver.findElement(By.xpath("//div[@id='selOtherReports_item_5']")).getText());
			Thread.sleep(3000);
			ObjectHelper.driver.findElement(By.xpath("//div[@id='selOtherReports_item_5']")).click();
			Thread.sleep(3000);
		...
		BaseClass_Regression.bh.createbug(exceptionError, bugflag, exceptionflag, "VSTS_ID_11441",
